...
public class VertexArray {
	...
	public VertexArray(float[] vertices, byte[] indices, float[] textureCoordinates) {
		...
		// sarà possibile recuperare le coord. xyz dei vertici alla posizione 'Shader.VERTEX_ATTRIB = 0' all'interno dello Shader
		...
		// sono coordinate 3D float
		// sarà possibile recuperare le coord. UV dei vertici alla posizione 'Shader.TCOORD_ATTRIB = 1' all'interno dello Shader
